...
import com.vikrant.mykmmexampleapplication.entity.Links
import com.vikrant.mykmmexampleapplication.entity.Rocket
...
internal class Database(databaseDriverFactory: DatabaseDriverFactory) {
    ...
    internal fun clearDatabase() {
        FileUtils().writeFile("Database:clearDatabase")
        dbQuery.transaction {
    ...
    internal fun getAllLaunches(): List<RocketLaunch> {
        FileUtils().writeFile("Database:getAllLaunches")
    ...
    private fun mapLaunchSelecting(
        ...
        FileUtils().writeFile("Database:mapLaunchSelecting")
        return RocketLaunch(
    ...
    internal fun createLaunches(launches: List<RocketLaunch>) {
        FileUtils().writeFile("Database:createLaunches")
        dbQuery.transaction {
    ...
    private fun insertRocket(launch: RocketLaunch) {
        FileUtils().writeFile("Database:insertRocket")
    ...
    private fun insertLaunch(launch: RocketLaunch) {
        FileUtils().writeFile("Database:insertLaunch")
